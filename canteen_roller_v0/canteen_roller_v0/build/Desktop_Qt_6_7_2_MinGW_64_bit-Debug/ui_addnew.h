...
public:
    ...
    void setupUi(QWidget *Addnew)
    {
        ...
        in_hot_slider->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        ...
        canteen_box->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        ...
        selectpic_button->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
