...
public:
    ...
    void setupUi(QWidget *StartPage)
    {
        ...
        StartPage->setCursor(QCursor(Qt::CursorShape::ArrowCursor));
        home = new QPushButton(StartPage);
        home->setObjectName("home");
        home->setGeometry(QRect(760, 640, 80, 61));
        home->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        home->setStyleSheet(QString::fromUtf8("font: 16pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        ...
        roller->setFont(font);
        roller->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
...
"    border-radius: 70px; /* \350\256\276\347\275\256\346\214\211\351\222\256\347\232\204\345\234\206\350\247\222\345\215\212\345\276\204\357\274\214\344\275\277\345\205\266\345\221\210\347\216\260\345\234\206\345\275\242 */"));
        ...
        premodel_box->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        ...
        savemodel_button->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        ...
        distance_slider->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        ...
        price_slider->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        ...
        protein_slider->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        ...
        carbo_slider->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        ...
        fat_slider->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        ...
        hot_slider->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        ...
        coriander_box->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        ...
        pushButton->setGeometry(QRect(40, 627, 389, 81));
        pushButton->setStyleSheet(QString::fromUtf8("font: 26pt \"\346\245\267\344\275\223\";"));
    ...
    void retranslateUi(QWidget *StartPage)
    {
        ...
        home->setText(QCoreApplication::translate("StartPage", "\350\277\224\345\233\236", nullptr));
        ...
        pushButton->setText(QCoreApplication::translate("StartPage", "\350\256\276\347\275\256\350\207\252\345\267\261\347\232\204\345\234\260\347\220\206\344\275\215\347\275\256", nullptr));
    } // retranslateUi
