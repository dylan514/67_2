...
public:
    ...
    void setupUi(QWidget *distance)
    {
        ...
        comboBox->setGeometry(QRect(70, 90, 400, 50));
        ...
        pushButton->setGeometry(QRect(60, 530, 151, 111));
        ...
        pushButton_2->setGeometry(QRect(310, 530, 151, 111));
        ...
        label->setGeometry(QRect(520, 90, 511, 601));
        label->setPixmap(QPixmap(QString::fromUtf8("pic/school.jpg")));
