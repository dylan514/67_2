...
struct qt_meta_stringdata_CLASSdistanceENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSdistanceENDCLASS = QtMocHelpers::stringData(
    "distance",
    "homed",
    "",
    "reshow",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSdistanceENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject distance::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSdistanceENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSdistanceENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSdistanceENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<distance, std::true_type>,
        // method 'homed'
...
void distance::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &distance::homed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *distance::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSdistanceENDCLASS.stringdata0))
